...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "✨ Anne Hathaway Daily!\n\n#annehathaway #hollywood #celebrity #fashion"
        ...
        video = upload.video(
            ...
            name=title or 'Anne Hathaway Daily Video',
...
def main():
    ...
    description = sys.argv[2] if len(sys.argv) > 2 else "Daily Anne Hathaway Moment! ✨"
    title = sys.argv[3] if len(sys.argv) > 3 else "Anne Hathaway Daily"
